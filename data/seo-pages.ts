...
const authorityCruiseSeoPages: CruiseSeoPage[] = [
  ...
  },
  {
    ...
    title: "Best Weekend Cruises From Florida (2026): Short Bahamas & Quick Getaways",
    description: "Compare the best weekend cruises from Florida for 2026, including short Bahamas sailings, quick getaways, ports, hotels, transfers and current cruise searches.",
...
type V7CruiseSeed = [string, string, string, string, string, string, string[], string[]];

const v7CruiseProgrammaticPages: CruiseSeoPage[] = ([
  ["miami-weekend-cruise-guide", "Miami Weekend Cruise Guide | Short Sailings, Hotels & Activities", "Plan Miami weekend cruises with PortMiami tips, hotel timing, flights, pre-cruise activities, and Bahamas route ideas.", "Miami Weekend Cruise Guide", "Weekend cruises", "Miami weekend cruises are useful for travelers comparing short Bahamas sailings, cruise-night hotels, flights, and pre-cruise activities.", ["PortMiami works best when travelers compare airport timing, downtown or beach hotels, transportation, and local plans before boarding.", "Short sailings may still need careful packing, dinner reservations, and backup timing around traffic or weather."], ["cruises-from-miami", "weekend-cruises-from-miami", "miami-pre-cruise-activities"]],
  ["port-canaveral-weekend-cruise-guide", "Port Canaveral Weekend Cruise Guide | Orlando Flights & Bahamas Trips", "Plan Port Canaveral weekend cruises with Orlando flights, Cocoa Beach hotels, family sailings, and Bahamas cruise planning tips.", "Port Canaveral Weekend Cruise Guide", "Weekend cruises", "Port Canaveral weekend cruises connect Orlando flights, Cocoa Beach hotels, family travel, and short Bahamas sailings.", ["Protect the sailing schedule first, then compare hotels, transfers, flights, and nearby activities.", "Families should check ship style, cabin setup, port timing, and pre-cruise hotel logistics before booking."], ["cruises-from-port-canaveral", "bahamas-cruises-from-port-canaveral", "port-canaveral-cruise-port-guide"]],
  ["fort-lauderdale-weekend-cruise-guide", "Fort Lauderdale Weekend Cruise Guide | Port Everglades Trips", "Plan Fort Lauderdale weekend cruises with Port Everglades hotels, FLL airport tips, beach add-ons, and cruise planning notes.", "Fort Lauderdale Weekend Cruise Guide", "Weekend cruises", "Fort Lauderdale weekend cruises are useful for travelers who want Port Everglades access, beach hotels, airport convenience, and South Florida add-ons.", ["Compare FLL arrival time, port transfers, hotel location, and beach plans before picking a sailing.", "Cruise fares may change by date, cabin, ship, taxes, fees, and availability."], ["cruises-from-fort-lauderdale", "miami-vs-port-canaveral-cruises", "best-cruises-from-florida"]],
  ["tampa-weekend-cruise-guide", "Tampa Weekend Cruise Guide | Gulf Coast Cruise Planning", "Plan Tampa weekend cruises with Port Tampa Bay hotels, airport timing, Western Caribbean ideas, and Gulf Coast pre-cruise activities.", "Tampa Weekend Cruise Guide", "Gulf Coast cruises", "Tampa weekend cruises work for travelers who want a Gulf Coast cruise base with downtown hotels and optional beach add-ons.", ["Check sailing length, transfer timing, downtown hotel location, airport plans, and nearby Clearwater or St. Pete activities.", "Shorter cruises still need a realistic arrival plan and clear expectations about taxes, fees, and onboard extras."], ["tampa-cruises", "weekend-cruises-from-florida", "best-cruises-from-florida"]],
  ["jacksonville-cruise-guide", "Jacksonville Cruise Guide | North Florida Sailings & Hotels", "Plan Jacksonville cruise trips with North Florida port notes, hotel timing, Bahamas route ideas, and drive-to cruise planning.", "Jacksonville Cruise Guide", "North Florida cruises", "Jacksonville cruise planning is useful for North Florida travelers comparing drive-to sailings, hotels, and Bahamas-style routes.", ["Compare parking, hotel needs, sailing schedule, port timing, and whether nearby airports or road trip stops matter.", "Always confirm ship, route, and port details directly with the cruise source before booking."], ["jacksonville-cruise-deals", "best-bahamas-cruises-from-florida", "best-cruises-from-florida"]],
  ["bahamas-weekend-cruises-from-florida", "Bahamas Weekend Cruises From Florida | Port & Trip Guide", "Compare Bahamas weekend cruises from Florida with Miami, Port Canaveral, Fort Lauderdale, Tampa, and Jacksonville planning tips.", "Bahamas Weekend Cruises From Florida", "Bahamas cruise guide", "Bahamas weekend cruises are one of Florida's strongest short-cruise search intents, but the best port depends on flights, hotels, and schedule.", ["Compare departure port, number of nights, private island stops, taxes, fees, and pre-cruise hotel cost.", "Short Bahamas sailings can be convenient, but cabin type and total trip cost still matter."], ["best-bahamas-cruises-from-florida", "weekend-cruises-from-florida", "bahamas-cruise-guide"]],
  ["family-bahamas-cruises-from-florida", "Family Bahamas Cruises From Florida | Ports, Ships & Planning Tips", "Plan family Bahamas cruises from Florida with port comparisons, kid-friendly ship notes, cabins, hotels, and packing tips.", "Family Bahamas Cruises From Florida", "Family cruise guide", "Family Bahamas cruises should be compared by ship style, kids programs, cabin setup, port timing, and pre-cruise hotel needs.", ["Port Canaveral is often strong for Orlando families, while Miami and Fort Lauderdale can work well for South Florida flights.", "Confirm cabin capacity, fees, gratuities, documents, and cancellation terms before booking."], ["family-cruises-from-florida", "bahamas-cruises-from-port-canaveral", "first-time-cruise-guide"]],
  ["couples-cruises-from-florida", "Couples Cruises From Florida | Romantic Sailings & Port Tips", "Compare couples cruises from Florida with Miami, Fort Lauderdale, Tampa, Port Canaveral, Bahamas, Caribbean, and pre-cruise hotel ideas.", "Couples Cruises From Florida", "Couples cruise guide", "Couples cruises from Florida can lean romantic, relaxed, food-focused, island-focused, or premium depending on the port and ship.", ["Compare ship style, dining, cabin type, destination, hotel night, and departure city before choosing only by base fare.", "Miami, Fort Lauderdale, Tampa, and Port Canaveral all support different pre-cruise trip styles."], ["best-cruises-from-florida", "bahamas-vs-caribbean-cruises", "cruise-vs-resort-vacation"]],
  ["cheap-bahamas-cruises-from-florida", "Cheap Bahamas Cruises From Florida | Value Planning Guide", "Compare cheap Bahamas cruises from Florida with fare caveats, port options, fees, cabin types, hotels, and total trip cost tips.", "Cheap Bahamas Cruises From Florida", "Budget cruise guide", "Cheap Bahamas cruises should be compared by total cost, not base fare alone.", ["Taxes, fees, gratuities, drinks, excursions, parking, hotels, and transportation can change the real cost.", "Flexible travelers should compare ports and dates before assuming one sailing is the best value."], ["cheap-cruises-from-florida", "best-bahamas-cruises-from-florida", "weekend-cruises-from-florida"]],
  ...
  ["port-canaveral-hotels-and-activities", "Port Canaveral Hotels & Activities | Pre-Cruise Planning Guide", "Plan Port Canaveral hotels and activities with Cocoa Beach stays, Orlando flights, Kennedy Space Center, and cruise timing tips.", "Port Canaveral Hotels & Activities", "Port Canaveral pre-cruise", "Port Canaveral pre-cruise days can include Cocoa Beach, Kennedy Space Center, family hotels, and Orlando-area arrivals.", ["Compare transfer time, hotel location, parking, breakfast, and morning port access.", "Protect the sailing first and keep local plans simple."], ["port-canaveral-cruise-port-guide", "cruises-from-port-canaveral", "bahamas-cruises-from-port-canaveral"]],
  ["cruise-packing-list-for-florida-families", "Cruise Packing List For Florida Families | Ship, Beach & Port Tips", "Pack for Florida family cruises with ship rules, beach gear, documents, medications, carry-ons, and pre-cruise hotel planning.", "Cruise Packing List For Florida Families", "Family packing guide", "A Florida family cruise packing list should cover documents, medications, first-day carry-ons, beach items, ship rules, and port plans.", ["Keep gear compact and check cruise line rules before packing specialty items.", "Affiliate gear links should support packing guidance without making unsupported product claims."], ["florida-cruise-packing-essentials", "first-time-cruise-guide", "family-cruises-from-florida"]],
  ["cruise-rain-gear-packing-guide", "Cruise Rain Gear Packing Guide | Florida Ports & Tropical Weather", "Plan cruise rain gear for Florida departures with compact packing, waterproof bags, shoes, port days, and tropical weather reminders.", "Cruise Rain Gear Packing Guide", "Weather packing guide", "Florida cruise travelers should pack for sun and rain, especially when sailing in warm-weather and tropical seasons.", ["Compact rain gear, dry storage, and flexible shoes can help without overpacking.", "Confirm product details, cruise rules, and excursion requirements before buying gear."], ["florida-cruise-packing-essentials", "summer-cruises-from-florida", "first-time-cruise-guide"]],
  ["cruise-vs-florida-road-trip", "Cruise vs Florida Road Trip | Which Vacation Works Better?", "Compare a cruise and a Florida road trip by hotels, ports, beaches, costs, activities, family travel, and planning style.", "Cruise vs Florida Road Trip", "Vacation comparison", "A cruise and a Florida road trip both simplify some parts of travel while creating different planning tradeoffs.", ["Cruises bundle transportation and lodging after boarding, while road trips give more control over cities, hotels, and activities.", "Compare total cost, travel style, family needs, and weather flexibility before choosing."], ["cruise-vs-resort-vacation", "best-cruises-from-florida", "first-time-cruise-guide"]],
  ["miami-yacht-day-before-cruise", "Miami Yacht Day Before A Cruise | Pre-Cruise Boating Guide", "Plan a Miami yacht or boat day before a cruise with PortMiami hotels, weather timing, group planning, and affiliate-link caveats.", "Miami Yacht Day Before A Cruise", "Boating pre-cruise guide", "A Miami boat or yacht day can be a memorable pre-cruise activity when timing, weather, hotel location, and port transfer plans are realistic.", ["Use internal planning links until exact Sailo affiliate URLs are available.", "Avoid same-day boating plans that could risk boarding time."], ["miami-pre-cruise-activities", "things-to-do-before-a-miami-cruise", "florida-cruise-port-activities"]],
  ["florida-cruise-outdoor-gear-guide", "Florida Cruise Outdoor Gear Guide | Beach, Rain & Port-Day Packing", "Plan Florida cruise outdoor gear for beach excursions, rainy port days, fishing add-ons, compact bags, and warm-weather travel.", "Florida Cruise Outdoor Gear Guide", "Outdoor gear guide", "Florida cruise outdoor gear should be compact, useful, and aligned with the itinerary rather than a generic product list.", ["Beach excursions, rainy port days, fishing add-ons, and hotel nights all need different packing decisions.", "Confirm product details with the merchant and cruise rules with the cruise line."], ["florida-cruise-packing-essentials", "cruise-rain-gear-packing-guide", "cruise-packing-list-for-florida-families"]]
] as V7CruiseSeed[]).map(([slug, title, description, h1, eyebrow, intro, seoCopy, relatedSlugs]) => ({
  slug,
  title,
  description,
  h1,
  ...
  seoCopy,
  details: [
    "Compare port, ship, sailing length, cabin type, fees, hotel needs, and transportation before booking.",
