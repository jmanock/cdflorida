      ...
      <main className="min-h-screen bg-sand px-4 py-12 text-ink sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl rounded-3xl border border-slate-200 bg-white p-6 shadow-card sm:p-8">
          ...
          <p className="mt-6 leading-7 text-slateText">
            Florida Cruise Deals curates cruise searches, port guides, destination ideas, and planning resources from Miami, Port Canaveral, Tampa, Fort Lauderdale, and Jacksonville. The site is part of Florida Deals Hub, a family of Florida-focused travel and local savings brands.
          </p>
          <p className="mt-4 leading-7 text-slateText">
            Our focus is simple: make Florida port sailings easier to scan, compare, and revisit while reminding travelers that fares may change, taxes and port fees may apply, and availability varies by sailing.
          </p>
        </div>
      </main>
      <SiteFooter />
