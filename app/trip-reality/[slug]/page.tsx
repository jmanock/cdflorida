...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!guide) return {};
  const url = `https://cruisedealsflorida.org/trip-reality/${guide.slug}`;
  return {
    title: guide.title,
    description: guide.description,
    alternates: { canonical: url },
    openGraph: { title: guide.title, description: guide.description, url, siteName: "Cruise Deals Florida", type: "article", images: [{ url: guide.heroImage, width: 1200, height: 630, alt: guide.heroAlt }] },
